...
namespace out {
  ...
  template <typename... Args>
  void debug_info(fmt::format_string<Args...> fmt, Args&&... args) {
#ifndef NDEBUG
  ...
  template <typename... Args>
  void debug_warning(fmt::format_string<Args...> fmt, Args&&... args) {
#ifndef NDEBUG
  ...
  template <typename... Args>
  void debug_error(fmt::format_string<Args...> fmt, Args&&... args) {
#ifndef NDEBUG
  ...
  template <typename... Args>
  void debug_critical(fmt::format_string<Args...> fmt, Args&&... args) {
#ifndef NDEBUG
